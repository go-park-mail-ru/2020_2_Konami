...
func (m *MockRepository) Validate(token string) error {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Validate(token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Validate", reflect.TypeOf((*MockRepository)(nil).Validate), token)
}
